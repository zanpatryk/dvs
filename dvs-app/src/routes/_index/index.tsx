		...
		<>
			<div className="flex flex-col items-center justify-center gap-6 h-[calc(100svh-6rem)]">
				...
				<p className="text-muted-foreground text-lg max-w-xl text-justify">
					A <strong>transparent</strong>, <strong>secure</strong>, and{" "}
					<strong>tamper-proof</strong> voting platform built on{" "}
					<strong>blockchain technology</strong>. Whether you're
					managing a <strong>local election</strong>, a{" "}
					<strong>community poll</strong>, or a{" "}
					<strong>global decision-making process</strong>, our system
					ensures that <strong>every vote counts</strong> — and{" "}
					<strong>every voice is heard</strong>.
				</p>
				<p className="text-muted-foreground text-lg max-w-xl text-justify">
